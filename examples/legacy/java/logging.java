...
public class logging {
  ...
  public static void main(String args[]) {
    ...
    Log.RegisterHandler(LogLevelGMSEC.ERROR, errorHandler);    
    Log.RegisterHandler(LogLevelGMSEC.WARNING, warningHandler);    
    Log.RegisterHandler(LogLevelGMSEC.INFO, infoHandler);    
    Log.RegisterHandler(LogLevelGMSEC.VERBOSE, verboseHandler);    
    Log.RegisterHandler(LogLevelGMSEC.DEBUG, debugHandler);    
    ...
    Log.SetReportingLevel(LogLevelGMSEC.VERBOSE);
    ...
    // Log.SetReportingLevel(LogLevelGMSEC.VERBOSE), used above, does not
    ...
    /* Set logging reporting level to now allow DEBUG messages to be 
       shown */
    Log.SetReportingLevel(LogLevelGMSEC.DEBUG);
    if (Log.GetReportingLevel() == LogLevelGMSEC.DEBUG)
    {
        Log.Info("Changed reporting level to LogLevelGMSEC.DEBUG");
    }
    else
    {
        Log.Error("Failed to change reporting level to LogLevelGMSEC.DEBUG");
    }
