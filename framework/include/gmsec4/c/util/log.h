...
#include <gmsec4_defs.h>  /* For LogEntry and LogLevelGMSEC */
...
extern "C"
{
	...
	/**
	 * @fn void logSetReportingLevel(GMSEC_LogLevelGMSEC level)
	 *
	 ...
	 */
	GMSEC_API void logSetReportingLevel(GMSEC_LogLevelGMSEC level);


	/**
	 * @fn GMSEC_LogLevelGMSEC logGetReportingLevel()
	 *
	 ...
	 */
	GMSEC_API GMSEC_LogLevelGMSEC logGetReportingLevel();


	/**
	 * @fn GMSEC_BOOL logIsLoggingEnabled(GMSEC_LogLevelGMSEC level)
	 *
	 ...
	 * @sa logGetReportingLevel()
	 */
	GMSEC_API GMSEC_BOOL logIsLoggingEnabled(GMSEC_LogLevelGMSEC level);
	...
	/**
	 * @fn void logRegisterHandlerByLevel(GMSEC_LogLevelGMSEC level, GMSEC_LogHandler* handler)
	 *
	 ...
	 * @param[in] handler - the logger handler
	 */
	GMSEC_API void logRegisterHandlerByLevel(GMSEC_LogLevelGMSEC level, GMSEC_LogHandler* handler);


	/**
	 * @fn const char* LogLevelGMSECToString(GMSEC_LogLevelGMSEC level)
	 *
	 * @brief This function converts the log level number to a string value
	 *
	 * @param[in] level - the logging level
	 */
	GMSEC_API const char* LogLevelGMSECToString(GMSEC_LogLevelGMSEC level);


	/**
	 * @fn GMSEC_LogLevelGMSEC LogLevelGMSECFromString(const char* level)
	 *
	 * @brief This function converts the string value to the log level number
	 *
	 * @param[in] level - the logging level as a string
	 */
	GMSEC_API GMSEC_LogLevelGMSEC LogLevelGMSECFromString(const char* level);


	GMSEC_API void logPrint(const char* file, int line, GMSEC_LogLevelGMSEC level, const char* fmt, ...);
