...
#include <gmsec4_defs.h>           // For LogLevelGMSEC
...
public:
	...
	/**
	 * @fn static void registerHandler(LogLevelGMSEC level, LogHandler* handler)
	 *
	 ...
	 *                  class is LogHandler.
	 */
	static void registerHandler(LogLevelGMSEC level, LogHandler* handler);
