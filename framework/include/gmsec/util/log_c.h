...
extern "C"
{
	...
	/** @fn void gmsec_SetReportingLevel(enum LogLevelGMSEC level)
	 *
	 ...
	 */
	GMSEC_DEPRECATED GMSEC_API void gmsec_SetReportingLevel(enum LogLevelGMSEC level);

	/** @fn enum LogLevelGMSEC gmsec_GetReportingLevel()
	 *
	 ...
	 * @sa gmsec_GetReportingLevel()
	 */
	GMSEC_DEPRECATED GMSEC_API enum LogLevelGMSEC gmsec_GetReportingLevel();

	/** @fn GMSEC_BOOL gmsec_IsLoggingEnabled(enum LogLevelGMSEC level)
	 *
	 ...
	 */
	GMSEC_DEPRECATED GMSEC_API GMSEC_BOOL gmsec_IsLoggingEnabled(enum LogLevelGMSEC level);
	...
	/** @fn void gmsec_RegisterLogHandlerByLevel(enum LogLevelGMSEC level, GMSEC_LOGGER_HANDLER *handler)
	 *
	 ...
	 * @param[in] handler - the logger handler
	 */
	GMSEC_DEPRECATED GMSEC_API void gmsec_RegisterLogHandlerByLevel(enum LogLevelGMSEC level, GMSEC_LOGGER_HANDLER *handler);

	/** @fn const char* gmsec_LogLevelGMSECToString(enum LogLevelGMSEC level)
	 *
	 * @brief This function converts the log level number to a string value
	 *
	 * @param[in] level - the logging level
	 */
	GMSEC_DEPRECATED GMSEC_API const char* gmsec_LogLevelGMSECToString(enum LogLevelGMSEC level);

	/** @fn enum LogLevelGMSEC gmsec_LogLevelGMSECFromString(const char *level)
	 *
	 * @brief This function converts the string value to the log level number
	 *
	 * @param[in] level - the logging level
	 */
	GMSEC_DEPRECATED GMSEC_API enum LogLevelGMSEC gmsec_LogLevelGMSECFromString(const char *level);

	GMSEC_DEPRECATED GMSEC_API void gmsec_CAPILog(enum LogLevelGMSEC level, char *fmt, ...);
