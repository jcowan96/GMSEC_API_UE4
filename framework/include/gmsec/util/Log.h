...
public:
	...
	~Logger();
	std::ostream& Get(LogLevelGMSEC level = logINFO);
...
public:
	...
	~LoggerStream();
	LogStream& Get(LogLevelGMSEC level = logINFO);
...
public:
	...
	/** @fn SetReportingLevel(LogLevelGMSEC level)
	 ...
	 *                logDEBUG
	 */
	GMSEC_DEPRECATED static void SetReportingLevel(LogLevelGMSEC level);
	 ...
	 */
	GMSEC_DEPRECATED static LogLevelGMSEC GetReportingLevel();
	 ...
	 *
	 */
	GMSEC_DEPRECATED static void RegisterHandler(LogLevelGMSEC level, LogHandler *handler);

	/** @fn ToString(LogLevelGMSEC level)
	 ...
	 *         or "INVALID"
	 */
	GMSEC_DEPRECATED static const char* ToString(LogLevelGMSEC level);
	 ...
	 *         logDEBUG
	 */
	GMSEC_DEPRECATED static LogLevelGMSEC FromString(const char *level);
	...
	*/
	...
	GMSEC_DEPRECATED static void RegisterHandler(LogLevelGMSEC level, GMSEC_LOGGER_HANDLER *handler);

private:
	// Log() {};
	// friend class Logger;
	static LogLevelGMSEC fMaxLevel;
};


inline LogLevelGMSEC Log::GetReportingLevel()
{
#if 0
	return fMaxLevel;
#else
