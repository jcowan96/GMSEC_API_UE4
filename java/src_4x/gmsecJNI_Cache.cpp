...
void Cache::initialize(JNIEnv* jenv)
{
	...
	fieldLogLevel_value = getFieldID(jenv, clazz, "level", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
	...
	// gov.nasa.gsfc.gmsec.api.LogLevelGMSEC initialization
	clazz                = getClass(jenv, "gov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC");
	classLogLevel        = clazz;
    fieldLogLevelNONE    = jenv->GetStaticFieldID(clazz, "NONE", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelERROR   = jenv->GetStaticFieldID(clazz, "ERROR", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelSECURE  = jenv->GetStaticFieldID(clazz, "SECURE", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelWARNING = jenv->GetStaticFieldID(clazz, "WARNING", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelINFO    = jenv->GetStaticFieldID(clazz, "INFO", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelVERBOSE = jenv->GetStaticFieldID(clazz, "VERBOSE", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
    fieldLogLevelDEBUG   = jenv->GetStaticFieldID(clazz, "DEBUG", "Lgov/nasa/gsfc/gmsec/api/util/LogLevelGMSEC;");
