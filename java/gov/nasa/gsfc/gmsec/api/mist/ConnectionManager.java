...
public class ConnectionManager
{
	 ...
	 *
	 * @throws A GMSEC_Exception is thrown if an anomaly occurs while attempting to connect to the middleware server.
	 */
	 ...
	 */
	public Connection.ConnectionState getState() throws GMSEC_Exception
	{
	 ...
	 * returning an error status if this operation is not successful. 
	 */
	public String getLibraryRootName() throws GMSEC_Exception
	{
	 ...
	 * @throws A GMSEC_Exception if an unknown anomaly occurs.
	 */
	 ...
	 * @fn String getName()
	 *
	 * @desc Returns the name of the connection, automatically generated or user specified.
	 */
	public String getName() throws GMSEC_Exception
	{
	 ...
	 * @fn String getID()
	 *
	 * @desc Returns the string ID for this connection.
	 */
	public String getID() throws GMSEC_Exception
	{
	 ...
	 * @fn String getMWInfo()
	 *
	 * @desc Returns the string containing middleware information.
	 */
	public String getMWInfo() throws GMSEC_Exception
	{
	 ...
	 *
	 * @desc Retrieves the number of messages queued for asynchronous publish operations
	 */
	public long getPublishQueueMessageCount() throws GMSEC_Exception
	{
